...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const daiTokenAddress = "0x6196bC61AE94ae4a8555686c4993ce021Cc6C636" // Replace DAI Address Here
  ...
  render() {
    return (
      <div>
        <nav className="navbar  fixed-top  flex-md-nowrap p-0 " style={{backgroundColor:''}}>
          <a
            ...
            <main role="main" className="col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto" style={{ width: "500px" }}>
                ...
                <table className="table">
                  <thead>
                    <tr>
                      <th scope="col" style={{ paddingLeft: "40px", textAlign:'left' }}>Recipient</th>
